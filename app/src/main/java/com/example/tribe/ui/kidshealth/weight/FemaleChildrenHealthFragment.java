...
public class FemaleChildrenHealthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_female_children_health, container, false);


        description = view.findViewById(R.id.detail_text_children_female);
        ageEditText = view.findViewById(R.id.female_age_children);
        buttonResult = view.findViewById(R.id.button_result_children_female);
            ...
            public void onClick(View view) {
                ...
                if(!ageEditText.getText().toString().isEmpty()){
                    ...
                    if(age>=2 && age<=12){
                        ...
                        Toast.makeText(getActivity(), "Please enter age between 2 to 12 years", Toast.LENGTH_SHORT).show();
                    }
