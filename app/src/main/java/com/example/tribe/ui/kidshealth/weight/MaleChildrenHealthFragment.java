...
public class MaleChildrenHealthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_male_children_health, container, false);


        description = view.findViewById(R.id.detail_text_children);
        ageEditText = view.findViewById(R.id.age_children);
        buttonResult = view.findViewById(R.id.button_result_children);
