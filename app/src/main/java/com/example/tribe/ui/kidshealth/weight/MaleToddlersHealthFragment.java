...
public class MaleToddlersHealthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_male_toddlers_health, container, false);



        description = view.findViewById(R.id.detail_text_toddlers);
        ageEditText = view.findViewById(R.id.age_toddlers);
        buttonResult = view.findViewById(R.id.button_result_toddlers);
