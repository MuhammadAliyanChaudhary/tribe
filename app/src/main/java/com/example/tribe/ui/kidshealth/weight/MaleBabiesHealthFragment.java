...
public class MaleBabiesHealthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_babies_weight, container, false);


        description = view.findViewById(R.id.detail_text);
