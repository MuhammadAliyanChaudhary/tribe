...
public class FemaleToddlersHealthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_female_toddlers_health, container, false);



        description = view.findViewById(R.id.detail_text_toddlers_female);
        ageEditText = view.findViewById(R.id.age_toddlers_female);
        buttonResult = view.findViewById(R.id.button_result_toddlers_female);
            ...
            public void onClick(View view) {
                ...
                if(!ageEditText.getText().toString().isEmpty()){
                    ...
                    if(age>=12 && age<=23){
                        ...
                        Toast.makeText(getActivity(), "Please enter age between 12 to 23 months", Toast.LENGTH_SHORT).show();
                    }
