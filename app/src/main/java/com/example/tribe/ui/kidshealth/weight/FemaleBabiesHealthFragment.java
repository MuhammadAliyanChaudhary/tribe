...
public class FemaleBabiesHealthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view = inflater.inflate(R.layout.fragment_female_babies_health, container, false);



        description = view.findViewById(R.id.detail_text_babies_female);
        ageEditText = view.findViewById(R.id.edit_text_babies_female);
        buttonResult = view.findViewById(R.id.button_result_babies);
            ...
            public void onClick(View view) {
                ...
                if(!ageEditText.getText().toString().isEmpty()){
                    ...
                    if(age>=0 && age<=11){
                        ...
                        Toast.makeText(getActivity(), "Please enter age between 0 to 11 months", Toast.LENGTH_SHORT).show();
                    }
