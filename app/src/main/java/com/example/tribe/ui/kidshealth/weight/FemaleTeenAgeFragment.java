...
public class FemaleTeenAgeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=  inflater.inflate(R.layout.fragment_female_teen_age, container, false);

        description = view.findViewById(R.id.detail_text_teen_female);
        ageEditText = view.findViewById(R.id.age_teen_female);
        buttonResult = view.findViewById(R.id.button_result_teen_female);
