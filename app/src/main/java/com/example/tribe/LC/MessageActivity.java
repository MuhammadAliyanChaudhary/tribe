...
import com.example.tribe.Adapters.MessageAdapter;
import com.example.tribe.Model.Chat;
import com.example.tribe.Model.User;
import com.example.tribe.Notifications.Client;
...
import com.example.tribe.Services.APIService;
...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profile_image = findViewById(R.id.dependent_profile_item);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    Data data = new Data(fuser.getUid(), R.drawable.default_image, username+": "+message, "New Message",
                            userid);
