...
public final class CommentItemBinding implements ViewBinding {
  ...
  private CommentItemBinding(@NonNull RelativeLayout rootView, @NonNull TextView comment,
      @NonNull CircleImageView imageProfile, @NonNull TextView username) {
  ...
  public static CommentItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CommentItemBinding((RelativeLayout) rootView, comment, imageProfile, username);
    }
