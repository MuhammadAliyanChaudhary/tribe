...
public final class FragmentMenuBinding implements ViewBinding {
  ...
  @NonNull
  public final CardView islam;

  @NonNull
  public final CardView kidshealth;

  @NonNull
  public final CardView learning;
  ...
  private FragmentMenuBinding(@NonNull LinearLayout rootView, @NonNull AppBarLayout appBarLayout,
      ...
      @NonNull CardView islam, @NonNull CardView kidshealth, @NonNull CardView learning,
  ...
  public static FragmentMenuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.islam;
      CardView islam = ViewBindings.findChildViewById(rootView, id);
      if (islam == null) {
        break missingId;
      }

      id = R.id.kidshealth;
      CardView kidshealth = ViewBindings.findChildViewById(rootView, id);
      if (kidshealth == null) {
        break missingId;
      }

      id = R.id.learning;
      CardView learning = ViewBindings.findChildViewById(rootView, id);
      if (learning == null) {
        break missingId;
      }
      ...
      return new FragmentMenuBinding((LinearLayout) rootView, appBarLayout, community,
          iconCommunity, iconFridge, iconHealth, iconIslam, iconLearning, islam, kidshealth,
          learning, logoutBtn, mainMenuToolbar, memories);
    }
