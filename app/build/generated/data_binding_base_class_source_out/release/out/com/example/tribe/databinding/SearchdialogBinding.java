...
public final class SearchdialogBinding implements ViewBinding {
  ...
  private SearchdialogBinding(@NonNull ConstraintLayout rootView, @NonNull CardView cardView,
  ...
  public static SearchdialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SearchdialogBinding((ConstraintLayout) rootView, cardView, recyclerView,
          searchUsers);
    }
