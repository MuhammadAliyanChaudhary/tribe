...
public final class UserItemBinding implements ViewBinding {
  ...
  private UserItemBinding(@NonNull RelativeLayout rootView, @NonNull CircleImageView imgOff,
      @NonNull CircleImageView imgOn, @NonNull TextView lastMsg,
  ...
  public static UserItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new UserItemBinding((RelativeLayout) rootView, imgOff, imgOn, lastMsg, profileImage,
          username);
    }
